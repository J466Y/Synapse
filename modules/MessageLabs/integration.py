        ...
        try:
            ...
            for msg in unread:
                ...
                email_date = datetime.strptime(
                    msg["receivedDateTime"], "%Y-%m-%dT%H:%M:%SZ"
                )
    ...
    def createFullBody(self, fullbody):
        try:
            ...
            if len(r) > 0:
                ...
                values[7] = values[
                    7
                ].strip()  # remove empty lines/new lines from attachments
                values[8] = values[
                    8
                ].strip()  # remove empty lines/new lines from matched content
